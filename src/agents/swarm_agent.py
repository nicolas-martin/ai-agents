...
SWARM_MODELS = {
    ...
    "deepseek": (False, "deepseek", "deepseek-chat"),  # DeepSeek Chat - Fast chat model (API)
    "xai": (False, "xai", "grok-4-fast-reasoning"),  # Grok-4 fast reasoning ($0.20-$0.50/1M tokens)
    "openrouter_qwen": (False, "openrouter", "qwen/qwen3-max"),  # Qwen 3 Max - Powerful reasoning ($1.00/$1.00 per 1M tokens)
